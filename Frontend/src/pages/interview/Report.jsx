...
function Report() {
  ...
  return (
    <div className="min-h-screen bg-[#060b14] text-white p-2">
      ...
      <div className="mx-auto mt-3 flex max-w-7xl items-start gap-3">

        <Button
          variant="ghost"
          onClick={() => navigate(-1)}
          className="mt-4 shrink-0 px-2 text-zinc-400 hover:bg-zinc-900 hover:text-white"
        >
          <ArrowLeft className="h-5 w-5" />
        </Button>

        <div className="flex h-[88vh] min-h-0 flex-1 overflow-hidden rounded-3xl border border-slate-800 bg-black shadow-2xl">
          ...
          {/* CENTER CONTENT */}
          <main className="flex-1 min-h-0 bg-black p-8">
            <div className="flex h-full flex-col">
              ...
              <div className="mt-6 flex-1 overflow-y-auto hide-scrollbar space-y-4 pr-2">
          ...
          {/* RIGHT SIDEBAR */}
          <aside className="w-80 border-l border-slate-800 bg-black p-6 flex flex-col min-h-0 overflow-hidden">
            ...
            <div className="mt-8 flex min-h-0 flex-1 flex-col">
              ...
              <div className="space-y-3 overflow-y-auto pr-2 flex-1">
                {skillGaps.map((gap, idx) => (
                  <div
                    key={idx}
                    className={`rounded-lg border p-3 text-sm font-medium ${gap.severity === "high"
